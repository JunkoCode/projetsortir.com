...
class SortieFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $sortie1->setOrganisateur($this->getReference(UserFixtures::USER_1));
        $sortie1->setEtat($this->getReference(EtatFixtures::ETAT_PASSEE));
        $sortie1->setLieu($this->getReference(LieuFixtures::LIEU_SORTIE1));
        $sortie1->addParticipant(($this->getReference(UserFixtures::USER_1)));
        $sortie1->addParticipant(($this->getReference(UserFixtures::USER_3)));
        ...
        $sortie2->setOrganisateur($this->getReference(UserFixtures::USER_2));
        $sortie2->addParticipant($this->getReference(UserFixtures::USER_1));
        $sortie2->addParticipant($this->getReference(UserFixtures::USER_3));
        ...
        $sortie3->setOrganisateur($this->getReference(UserFixtures::USER_1));
        ...
        $sortie4->setDateLimiteInscription(new DateTimeImmutable("2022-09-15 10:30:00"));
        $sortie4->setDateHeureDebut(new DateTimeImmutable("2022-09-30 19:00:00"));
        $sortie4->setDuree(new DateInterval("PT3H30M"));
        $sortie4->setInfoSortie("test3");
        $sortie4->setNombreInscriptionMax(15);
        $sortie4->setOrganisateur($this->getReference(UserFixtures::USER_1));
        $sortie4->setEtat($this->getReference(EtatFixtures::ETAT_ANNULEE));
        $sortie4->setLieu($this->getReference(LieuFixtures::LIEU_SORTIE3));
